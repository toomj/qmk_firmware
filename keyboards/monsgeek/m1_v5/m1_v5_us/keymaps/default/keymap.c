...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FBL] = LAYOUT( /* Base */ 
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______, UM(0x1e9e),_______,  _______,  _______,
        _______,  _______,  _______,  _______,  BT_TEST,  _______,  _______,  _______,  _______,  _______,  _______, UM(0x00fc),_______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,UM(0x00f6),UM(0x00e4),          _______,  _______,
